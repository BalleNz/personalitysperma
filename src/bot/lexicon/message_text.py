...
class MessageText:
    ...
    # [ TYPIFICATION ]
    TYPIFICATION_PREROLL = (
        "ты сейчас будешь проходить типирование «{typification_name}»\n\n"
        "<b>что ты узнаешь о себе:</b>\n"
        "{characteristics_text}\n\n"
        "всего в тесте: <u>{typification_length}</u> вопросов\n"
        "<i>(но можно закончить раньше)</i>\n\n"
        "пожалуйста! отвечай честно и максимально подробно!\n\n"
        "<i>для лучшего анализа используй голосовые сообщения ~~</i>"
    )
