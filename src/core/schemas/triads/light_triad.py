...
class LightTriadsSchema(BaseModel):
    """СВЕТЛАЯ ТРИАДА"""
    ...
    faith_in_humanity: Optional[float] = Field(
        default=None,
        ge=0.0,
        le=1.0,
        description="Вера в человечность: 0=цинизм и недоверие → 1=глубокая вера в доброту людей"
    )
    humanism: Optional[float] = Field(
        default=None,
        ge=0.0,
        le=1.0,
        description="Гуманизм: 0=видеть людей как средство → 1=видеть в людях ценность саму по себе"
    )
    kantianism: Optional[float] = Field(
        default=None,
        ge=0.0,
        le=1.0,
        description="Кантианство: 0=манипулятивность → 1=уважение к автономии и достоинству других"
    )
    humility: Optional[float] = Field(
        default=None,
        ge=0.0,
        le=1.0,
        description="Скромность / humility: 0=нарциссизм и высокомерие → 1=скромность и принятие себя"
    )
